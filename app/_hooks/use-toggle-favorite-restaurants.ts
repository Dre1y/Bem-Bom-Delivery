...
const useToggleFavoriteRestaurant = ({userId, restaurantId, restaurantIsFavorited}: UseToggleFavoriteRestaurantProps) => {
    ...
    const handleFavoriteClick = async () => {
        ...
        try {
            ...
            toast(restaurantIsFavorited ? "Restaurante removido dos favoritos." : "Restaurante adicionado aos favoritos.", {
                action: {
                    label: "Ver Favoritos",
